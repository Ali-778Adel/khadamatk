...
class HomeScreen extends StatelessWidget {
  ...
  String link = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxiJQBK4qrR_l2f3OHLP0IdXggEoOH-3OVgQ&usqp=CAU';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return buildBestTech(context, cubit
                                .bestTechModel!.data![index]);
                          },
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                          ...
                          physics: BouncingScrollPhysics(),
                          itemBuilder: (context, index) {
                            return buildCategories(context, cubit
        ...
        Container(
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: NetworkImage(model.image==null||model.image
        ?.startsWith('public')==true?link:model.image!),
                  fit: BoxFit.contain),
              border: Border.all(
        ...
        Text(
         model.userService==null || model.userService!.subCategory==null?
          ...
          style: Theme.of(context)
              .textTheme
              .bodySmall!
              .copyWith(color: KJobColor),
        ),
        Row(
          children:
          List.generate(5, (index) => ratingIcon),
        ),
        OutlinedButton(
          onPressed: () {},
  ...
  Widget buildCategories(context,DataCat model){
    return Column(
      children: [
        ...
        SizedBox(height: 10,),
        Text(model.name!,style: Theme.of(context)
